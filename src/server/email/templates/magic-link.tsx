...
const MagicLinkEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your Parkway Shipping Application magic link is ready</Preview>
      <Tailwind>
          ...
          <Container className="bg-white border border-gray-200 rounded-lg p-[32px] max-w-[600px] mx-auto">
            <Section className="mb-[32px]">
              ...
              <Heading className="text-gray-900 text-[24px] font-medium mb-[16px]">
                Sign in to Parkway Shipping Application
              </Heading>
              <Text className="text-gray-700 mb-[24px]">Hi {name},</Text>
              <Text className="text-gray-700 mb-[24px]">
                We received a request to sign in to your Parkway Shipping
                Application account. Click the button below to securely sign in
                without a password:
              </Text>
