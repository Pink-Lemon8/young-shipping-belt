            ...
            <div className="bg-muted/50 p-3 rounded-lg">
              ...
              <div className="flex flex-col">
                ...
                <p className="font-semibold text-base">
                  {data.patient?.["momex:firstname"]?._cdata ??
                    data.shippingAddress?.["momex:firstname"]?._cdata ??
                    ""}{" "}
                  {data.patient?.["momex:lastname"]?._cdata ??
                    data.shippingAddress?.["momex:lastname"]?._cdata ??
                    ""}
                </p>
              </div>
            </div>
