...
export function UserNav() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="cursor-pointer flex flex-row items-center transition-all duration-300 gap-2 border-2 bg-background backdrop-blur-sm px-3 py-1 rounded-full">
