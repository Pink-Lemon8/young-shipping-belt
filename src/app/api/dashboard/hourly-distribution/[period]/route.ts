...
import { getHourlyDistributionForPeriod } from "@/server/controller/dashboard";
...
export async function GET(
  ...
  try {
    ...
    const data = await getHourlyDistributionForPeriod(period as (typeof VALID_PERIODS)[number]);
